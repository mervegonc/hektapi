...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  const links = [
    ...
    { href: "/admin/standartlar", label: "📋 Sertifikalar" },
  ...
  return (
    <div className="min-h-screen bg-zinc-100">
     ...
     <aside className={`fixed top-0 left-0 z-40 w-64 bg-navy-950 text-white flex flex-col transform transition-transform duration-300 ${sidebarOpen ? "translate-x-0" : "-translate-x-full"} lg:translate-x-0`} style={{ height: "100vh", minHeight: "-webkit-fill-available" }}>
